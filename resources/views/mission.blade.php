...
<body>
            ...
            @if (app()->getLocale()=="en")
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="{{url('/')}}" class="nav-item nav-link active">{{__('menu.Home')}}</a>
                        <a href="{{url('/')}}" class="nav-item nav-link">{{__('menu.About')}}</a>
                        <a href="{{url('/')}}" class="nav-item nav-link">{{__('menu.WEB3.0 GameFi')}}</a>
                        <a href="{{url('/')}}" class="nav-item nav-link">{{__('menu.Learn to Earn')}}</a>
                        <a href="{{url('/')}}" class="nav-item nav-link">{{__('menu.Projects')}}</a>
                        <a href="{{url('/')}}" class="nav-item nav-link">{{__('menu.Articles')}}</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">{{__('menu.Our Missions and Projects')}}</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">{{__('menu.Home')}}</a></li>
                    <li class="breadcrumb-item" aria-current="page">{{__('menu.Our Missions and Projects')}}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="img-fluid w-100" src="{{url('uploads/images/mission/'.$mission->image_major)}}" alt="" style="height:400px" >
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s" >

                    <h5 class="mb-3">{{__('menu.Name Mission')}}</h5>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $mission->en_name : $mission->ar_name!!}</p>
                    <h5 class="mb-3">{{__('menu.Glance Mission')}}</h5>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $mission->en_glance : $mission->ar_glance!!}</p>
                    <h5 class="mb-3">{{__('menu.Registration mechanism')}}</h5>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $mission->en_registration_mechanism : $mission->ar_registration_mechanism!!}</p>
                    <h5 class="mb-3">{{__('menu.Registration win')}}</h5>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $mission->en_win_mechanism : $mission->ar_win_mechanism!!}</p>
         
                    <div class="d-flex">
                    <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->tele1}}"><i class="fab fa-telegram"></i></a>

                        @if($mission->tele2 ==NUll)
                        @else
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->tele2}}"><i class="fab fa-telegram"></i></a>
                        @endif
                        @if($mission->tele3 ==NUll)
                        @else
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->tele3}}"><i class="fab fa-telegram"></i></a>
                        @endif
                        @if($mission->tele4 ==NUll)
                        @else
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->tele4}}"><i class="fab fa-telegram"></i></a>
                        @endif
                    </div>
                    <br>
                    <div class="d-flex">
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->link}}"><i class="fa fa-link"></i></a>
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->discord}}"><i class="fab fa-discord"></i></a>
                        <a class="btn btn-lg-square btn-primary me-2" href="{{$mission->twitter}}"><i class="fas fa-times"></i></a>
                    </div>
                </div>
            </div>
