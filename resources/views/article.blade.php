...
<body>
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">{{__('menu.Our Articles')}}</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">{{__('menu.Home')}}</a></li>
                    <li class="breadcrumb-item" aria-current="page">{{__('menu.Our Articles')}}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="img-fluid w-100" src="{{url('uploads/images/article/'.$article->image_major)}}" alt="" style="height:auto;">
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
             
                    <h3 class="mb-3">{{__('menu.Writer article')}}</h3>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $article->en_writer : $article->ar_writer!!}</p>
                    <h3 class="mb-3">{{__('menu.Name article')}}</h3>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $article->en_name : $article->ar_name!!}</p>
                    <h3 class="mb-3">{{__('menu.Description article')}}</h3>
                    <p class="mb-4">{!!app()->getLocale() == "en" ? $article->en_desciption : $article->ar_desciption!!}</p>
                    <!-- <div class="d-flex">
    ...
    <div class="container-fluid header-carousel px-0 mb-5" style="width: 60%;">
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
              
                    @foreach ($article->images as $index => $img)
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}  d-flex align-items-center justify-content-center">
                            <img  src="{{ asset('uploads/images/article/'.$img->image) }}" alt="Image" width="50%" height="50%">
                        </div>
                    @endforeach
    ...
    @else
    <h3 style="margin-top: -100px;" class="text-center">{{__('menu.No album photo')}}</h3>
    <br>
    @endif
