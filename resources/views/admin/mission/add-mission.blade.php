...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Projects and Mission /</span> Add Projects and Mission  </h4>
                <form action="{{ route('store_mission') }}" method="POST" enctype="multipart/form-data" >
                    @csrf
                    @method('POST')
                 <div class="card">
                    <h5 class="card-header">Add Projects and Mission </h5>
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="enter english win mechanism"
                          aria-describedby="defaultFormControlHelp"
                        />
                        @if($errors->any('en_win_mechanism'))
                                           <span class="text-danger"> {{$errors->first('en_win_mechanism')}}</span>
                                     @endif
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          aria-describedby="defaultFormControlHelp"
                        />
                        @if($errors->any('ar_win_mechanism'))
                                           <span class="text-danger"> {{$errors->first('ar_win_mechanism')}}</span>
                                     @endif
                      </div>
                      <div>
